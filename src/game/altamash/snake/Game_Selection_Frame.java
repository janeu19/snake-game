...
public class Game_Selection_Frame extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==play)
		{
			...
			if(blueSnake.isSelected())
				flag=3;
			if(easy.isSelected())
				Game_Screen.snakeSpeed=60;
			if(medium.isSelected())
				Game_Screen.snakeSpeed=50;
			if(hard.isSelected())
				Game_Screen.snakeSpeed=40;
			if(yes.isSelected())
				gridFlag=1;
			new Game_Start_Frame();
			dispose();
		}
		if(e.getSource()==exit)
			dispose();
